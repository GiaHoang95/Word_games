...
def headerkm(url):
     st.markdown(f'<div style="width:35px;height:35px;display:flex;justify-content:center;align-items:center;background-color:#3941E5;color:#33ff33;border:0.5px solid #3941E5;font-size:26px;border-radius:0%;">{url}</div>', unsafe_allow_html=True)
