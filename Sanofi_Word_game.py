...
def head(url):
    st.markdown(f'<div style="opacity=0;display:flex;justify-content:center;align-items:center;background-color:#ffffff;color:#7A01E6;font-weight:bold;border: solid #ffffff;font-size:40px;border-radius:0%;">{url}</div>', unsafe_allow_html=True)
